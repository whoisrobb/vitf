...
const SectionShell = ({ className, children, title, subtitle, shimmerText }: SectionShellProps) => {
  return (
    <div className={cn("lg:px-8 md:px-4 px-2 w-full md:space-y-8 space-y-8", className)}>
        <div className="w-full relative grid place-items-center text-center space-y-6">
            ...
            <h1 className="md:text-3xl font-bold uppercase">{title}</h1>
